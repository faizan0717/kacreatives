        ...
        <div className="p-4 items-center justify-center">
          <div className="flex items-center justify-center ">
            <PinContainer
              ...
              href="https://twitter.com/mannupaaji"
            >
              <div onClick={() => window.open(`https://api.whatsapp.com/send?phone=${contactInfo.phNo}`, '_blank')} className="flex basis-full flex-col p-4 tracking-tight text-slate-100/50 sm:basis-1/2 w-[20rem] h-[20rem] ">
